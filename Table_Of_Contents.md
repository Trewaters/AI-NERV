...
gh repo create my-new-app --template Trewaters/template-react-vite --private --clone
...
gh repo create my-pwa-app --template Trewaters/template-react-vite-mui-pwa --private --clone \
...
gh repo create my-desktop-app --template Trewaters/template-electron-react-mui --private --clone \
  -d "Desktop app built with Electron, React, and MUI"

# New Hugo theme website from the hugo-theme template
gh repo create my-hugo-site --template Trewaters/template-hugo-theme --public --clone \
...
gh repo create client-app --template Trewaters/template-react-vite-mui-pwa --private --clone \
